...
export const NAV_ROUTES = [
  { href: "/speakers", label: "설교자", short: "설교자", key: "speakers" },
  { href: "/timetable", label: "일정표", short: "일정표", key: "timetable" },
...
export const TAB_ROUTES = [
  ...
  { href: "/timetable", label: "일정표", icon: "clock", key: "timetable" },
  { href: "/speakers", label: "설교자", icon: "user", key: "speakers" },
